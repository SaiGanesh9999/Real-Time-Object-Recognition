...
class Detector:
    ...
    def onVideo(self):
        ...
        while success:
            classLabelIDs, confidences, bboxs = self.net.detect(image, 0.4)
            ...
            if len(bboxIdx) != 0:
                ...
                for i in range(0, len(bboxIdx)):
                    ...
                    displayText = classLabel +" "+str(count) #"{}:{:.2f}".format(classLabel, classConfidence)
                    x,y,w,h = bbox
                    ...
                    cv2.line(image, (x,y + h), (x + w, y + h - lineWidth), classColor, thickness = 5)
                    
                    cv2.line(image, (x + w,y + h), (x + w -lineWidth, y), classColor, thickness = 5)
